package com.blz.hiringcandidate.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.blz.hiringcandidate.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("LMS-HiringCandidate",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("LMS-HiringCandidate", "http://blz.hiringcandidate", "gvpavangv14@gmail.com"),
                "Apache 2.0",
